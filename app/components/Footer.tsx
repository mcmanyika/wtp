    ...
    <footer className="border-t border-slate-200 bg-white">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        <div className="grid gap-6 md:grid-cols-4">
          <div>
            <h3 className="mb-3 text-xs font-semibold text-slate-900">Get the App</h3>
            <p className="mb-3 text-xs text-slate-500">
              Download our Android app for quick access.
            </p>
            <span className="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-700">
          ...
          <div>
            <h3 className="mb-3 text-xs font-semibold text-slate-900">Quick Links</h3>
          ...
          <div>
            <h3 className="mb-3 text-xs font-semibold text-slate-900">Follow Us</h3>
            <p className="mb-3 text-xs text-slate-500">
