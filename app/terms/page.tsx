          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <div>
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                Welcome to the Diaspora Connect (&quot;Diaspora Connect&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). By
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                Diaspora Connect (Diaspora Connect) is Zimbabwe&apos;s diaspora intelligence platform designed to connect
                Zimbabwe and its global diaspora through trusted information, verified services, and structured
                economic and civic participation. The Platform provides tools for knowledge access, membership, volunteering,
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                Membership applications are subject to review and approval by Diaspora Connect. Membership contributions of $5 per
                month or $60 per year support our expert content creation, service provider verification, and platform
                development work. Membership may be revoked if a member engages in conduct that is inconsistent with
                Diaspora Connect&apos;s values, mission, or these terms.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                ...
                faith, represent Diaspora Connect respectfully, and adhere to any guidelines or instructions provided. Diaspora Connect reserves
            ...
            <div>
              ...
              <ul className="ml-5 list-disc space-y-2 text-sm text-slate-600 sm:text-base">
                ...
                <li>Donations are non-refundable unless required by law or at Diaspora Connect&apos;s sole discretion.</li>
                <li>Funds will be used to support Diaspora Connect&apos;s mission, programmes, and operational costs.</li>
            ...
            <div>
              ...
              <ul className="ml-5 list-disc space-y-2 text-sm text-slate-600 sm:text-base">
                ...
                <li>Use the Platform to promote violence, incite hatred, or undermine the platform&apos;s mission.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                ...
                of Diaspora Connect or its content providers and is protected by applicable intellectual property laws. You may not
                reproduce, distribute, modify, or create derivative works from any content on the Platform without
                prior written consent from Diaspora Connect.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                ...
                payment processors, and external resources). Diaspora Connect is not responsible for the content, privacy
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                The Platform is provided on an &quot;as is&quot; and &quot;as available&quot; basis. Diaspora Connect makes no warranties, express
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                To the fullest extent permitted by law, Diaspora Connect and its directors, officers, volunteers, and affiliates
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                You agree to indemnify and hold harmless Diaspora Connect, its directors, officers, volunteers, and affiliates
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
                ...
                notice, for conduct that we believe violates these terms or is harmful to other users, Diaspora Connect, or third
            ...
            <div>
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700 sm:text-base">
                <p className="font-semibold">Diaspora Connect (Diaspora Connect)</p>
                <p className="mt-1">
                  Email:{' '}
                  <a href="mailto:contact@wtp.com" className="text-blue-600 hover:underline">contact@wtp.com</a>
                </p>
                <p className="mt-1">
                  Website:{' '}
                  <a href="https://www.dcpzim.com" className="text-blue-600 hover:underline">www.dcpzim.com</a>
