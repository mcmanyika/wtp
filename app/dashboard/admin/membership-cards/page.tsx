...
export default function AdminMembershipCardsPage() {
  ...
  const handlePrintCard = (card: CardData) => {
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>DC Membership Card - ${card.memberName}</title>
        <style>
          ...
          <div class="card">
            <div class="card-front">
              <div class="card-header">
                <div class="card-logo" style="display:flex;align-items:center;justify-content:center;background:#fff;border-radius:10px;width:44px;height:44px;font-weight:800;font-size:16px;color:#0f172a;">DC</div>
                <div>
                  <div class="card-org-name">Diaspora Connect</div>
          ...
          <div class="card">
            <div class="card-back">
              <div class="card-back-header">
                <div class="card-back-title">Diaspora Connect</div>
                <div class="card-back-subtitle">Membership Terms & Conditions</div>
              </div>
              <ol class="card-terms">
                <li>This card is the property of the Diaspora Connect (DC).</li>
                <li>The holder is a registered member of Zimbabwe's diaspora intelligence platform.</li>
                <li>This card is non-transferable and must be presented upon request at DC events.</li>
                <li>Membership is valid for one year from the date of issue and subject to renewal.</li>
                <li>Lost or damaged cards should be reported to DC administration immediately.</li>
              </ol>
              <div class="card-back-footer">
                ...
                <p style="margin-top:4px">&copy; ${new Date().getFullYear()} DC. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="relative max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-6 text-white shadow-xl">
              ...
              <div className="relative z-10 mb-5 flex items-center gap-3">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-white text-lg font-extrabold text-slate-900">DC</span>
                <div>
                  <p className="text-sm font-bold tracking-wide">Diaspora Connect</p>
            ...
            <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-xl">
              <div className="mb-4 text-center">
                <p className="text-xs font-bold uppercase tracking-widest text-slate-900">Diaspora Connect</p>
              ...
              <div className="border-t border-slate-200 pt-3 text-center">
                ...
                <p className="text-[9px] text-slate-400">&copy; {new Date().getFullYear()} DC. All rights reserved.</p>
              </div>
            </div>
